  ...
  return <>
    <div className='h-full text-center select-none overflow-clip'>
      <div className={classNames(
        'grid place-content-center py-4 h-full bg-classy-300 text-classy-50 transition-transform ease-in-out duration-[3s] relative z-10',
        currentSchool === ''
          ? 'translate-x-0'
          : 'translate-x-[100%]'
      )}>
        <div className='flex flex-col gap-4 sm:gap-8 sm:rounded-2xl sm:shadow-2xl sm:p-8'>
          <header className='flex flex-col gap-4 sm:gap-8'>
            <img className='w-24 h-24 sm:w-36 sm:h-36 bg-classy-50 rounded-2xl mx-auto shadow-2xl' />
          ...
          <div className='flex flex-col gap-4 sm:gap8 sm:text-xl'>
            ...
            <ul className='bg-classy-200 text-classy-900 rounded-2xl'>
              {
